...
Calendar.setup = function (params) {
	...
	function onSelect(cal) {
		...
		if (update) {
			showEvent(cal.date.print(cal.dateFormat, p.ifDateType || cal.dateType, false));
		}
		// if (update && p.inputField) {
		// 	p.inputField.value = cal.date.print(cal.dateFormat, p.ifDateType || cal.dateType, false);
