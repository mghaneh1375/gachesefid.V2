...
Calendar.prototype.create = function (_par) {
	...
	var hh = function (text, cs, navtype) {
		...
		if(text == "&#x00ab;")
			cell.innerHTML = "<div unselectable='on'>سال قبل</div>";
		else if(text == "&#x2039;")
			cell.innerHTML = "<div unselectable='on'>ماه قبل</div>";
		else if(text == "&#x203a;")
			cell.innerHTML = "<div unselectable='on'>ماه بعد</div>";
		else if(text == "&#x00bb;")
			cell.innerHTML = "<div unselectable='on'>سال بعد</div>";
		else
