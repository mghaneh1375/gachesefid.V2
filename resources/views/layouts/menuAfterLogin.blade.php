...
@section('items')
    <li id="menu-item-1981" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-has-icon menu-item-1981"><a href="#" ><i class="menu-item-icon fa fa-check-circle" ></i>آزمون ها</a>
        <ul class="sub-menu sub-menu-has-icons">
            ...
            <li id="menu-item-1987" class="menu-item menu-item-type-custom menu-item-object-custom
                                menu-item-has-icon menu-item-1987"><a href="{{route('regularQuizRegistry')}}" ><i class="menu-item-icon fa fa-edit" ></i>ثبت نام در آزمون<i class="seoicon-right-arrow"
                    ></i></a></li>
    ...
    <li id="menu-item-1991" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-507 current_page_item menu-item-has-icon menu-item-1991"><a href="{{route('seeResult')}}" ><i class="menu-item-icon fa fa-glasses" ></i>کارنامه آزمون</a></li>
