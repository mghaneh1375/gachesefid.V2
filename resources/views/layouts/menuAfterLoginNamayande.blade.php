                        ...
                        <ul class="categories" id="categories">
                            ...
                            <li data-val="students" class="menuItem students"><a><span>دانش آموزان</span></a>
                                <ul class="subItem hidden students">
                                    ...
                                    <li class="sub_item"><a href="{{route('namayandeStudent')}}"><span>گزارش گیری از دانش آموزان</span></a></li>
                                </ul>
                            </li>

                            <li data-val="schools" class="menuItem schools"><a><span>مدارس</span></a>
                                <ul class="subItem hidden schools">
                                    <li class="sub_item"><a href="{{route('addSchool')}}"><span>افزودن مدرسه</span></a></li>
                                    <li class="sub_item"><a href="{{route('namayandeSchool')}}"><span>گزارش گیری از مدارس</span></a></li>
                                    <li class="sub_item"><a href="{{route('schoolsList')}}"><span>لیست مدارس</span></a></li>
                                </ul>
                            </li>
