            ...
            <nav class="primary-menu">
                ...
                <ul id="primary-menu" class="primary-menu-menu">
                    ...
                    <li id="menu-item-254" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-has-icon menu-item-254">
                        ...
                        <ul class="sub-menu sub-menu-has-icons">
                            <li id="menu-item-1954" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1954"><a href="{{route('addSchool')}}" >افزودن مدرسه<i class="seoicon-right-arrow" ></i></a></li>
                            <li id="menu-item-1975" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1975"><a href="{{route('namayandeSchool')}}" >گزارش گیری از مدارس<i class="seoicon-right-arrow" ></i></a></li>

                            <li id="menu-item-1975" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1975"><a href="{{route('schoolsList')}}" >لیست مدارس<i class="seoicon-right-arrow" ></i></a></li>
                        </ul>
                    </li>
                    ...
                    <li id="menu-item-600" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-has-icon menu-item-600">
                        <a href="#"><i class="menu-item-icon fa fa-group" ></i>آزمون ها</a>
                        <ul class="sub-menu sub-menu-has-icons">
