    ...
    <div class="_MAIN_" style="min-height: 90vh">
        <div class="row">
            ...
            <div class="col-xs-12" onclick="$('#mobileMenuBar').addClass('hidden');">
                ...
                <div class="col-xs-2 hideOn1200">
                    @section('sideBar')
                    @show
                </div>

                <div class="col-xs-8 fillWidthOnMobile">
                ...
                <div class="col-xs-2 hiddenOnMobile" style="min-width: 174px !important; float: right">
                    <div onclick="document.location.href = '{{route('home')}}'" class="SiteName" style="position: fixed; cursor: pointer; z-index: 10001">
